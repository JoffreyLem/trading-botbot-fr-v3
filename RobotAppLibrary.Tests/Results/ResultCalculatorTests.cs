...
public class ResultCalculatorTests
{
    ...
    public void CalculateResults_ShouldReturnCorrectResult_WhenPositionsHavePositiveAndNegativeProfits()
    {
        ...
        {
            new() { Profit = 100, DateClose = DateTime.Now.AddDays(-3) },
            new() { Profit = -50, DateClose = DateTime.Now.AddDays(-2) },
            new() { Profit = 200, DateClose = DateTime.Now.AddDays(-1) },
            new() { Profit = -100, DateClose = DateTime.Now }
        };
    ...
    public void CalculateResults_ShouldCalculateDrawdownsCorrectly()
    {
        ...
        {
            new() { Profit = 100, DateClose = DateTime.Now.AddDays(-3) },
            new() { Profit = 200, DateClose = DateTime.Now.AddDays(-2) },
            new() { Profit = 150, DateClose = DateTime.Now.AddDays(-1) },
            new() { Profit = 50, DateClose = DateTime.Now }
        };
    ...
    public void CalculateResults_ShouldCalculateNoDrawdown_WhenAllProfitsIncreasing()
    {
        ...
        {
            new() { Profit = 100, DateClose = DateTime.Now.AddDays(-3) },
            new() { Profit = 150, DateClose = DateTime.Now.AddDays(-2) },
            new() { Profit = 200, DateClose = DateTime.Now.AddDays(-1) },
            new() { Profit = 250, DateClose = DateTime.Now }
        };
    ...
    public void CalculateResults_ShouldHandleUnorderedPositionsList()
    {
        var positions = new List<Position>
        {
            new() { Profit = 100, DateClose = DateTime.Now.AddDays(-1) },
            new() { Profit = 200, DateClose = DateTime.Now.AddDays(-3) },
            new() { Profit = -50, DateClose = DateTime.Now.AddDays(-2) }
        };
