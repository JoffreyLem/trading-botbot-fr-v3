...
public class StrategyBaseTest
{
    ...
    public StrategyBaseTest()
    {
        ...
        _strategyServiceFactoryMock.Setup(x =>
                x.GetChart(It.IsAny<ILogger>(), It.IsAny<IApiProviderBase>(), It.IsAny<string>(), It.Is<Timeframe>(y=>y == Timeframe.Daily)))
            .Returns(_chartMockMain.Object);
        
        _strategyServiceFactoryMock.Setup(x =>
                x.GetChart(It.IsAny<ILogger>(), It.IsAny<IApiProviderBase>(), It.IsAny<string>(), It.Is<Timeframe>(y=>y == Timeframe.Monthly)))
            .Returns(_charmockMonthly.Object);
        
        _strategyServiceFactoryMock.Setup(x =>
                x.GetChart(It.IsAny<ILogger>(), It.IsAny<IApiProviderBase>(), It.IsAny<string>(), It.Is<Timeframe>(y=>y == Timeframe.Weekly)))
            .Returns(_chartMockWeekly.Object);


        _strategyServiceFactoryMock.Setup(x => x.GetStrategyResultService(It.IsAny<IApiProviderBase>(), It.IsAny<string>()))
    ...
    void InitializeChartMock(Mock<ChartForTest> chartMock, List<Candle> fakeHistory)
    {
        var internalList = new List<Candle>(fakeHistory);

 
        foreach (var t in internalList)
        {
            chartMock.Object.Add(t);
        }
    ...
    public void Init_Test_StrategyImplementation()
    {
        ...
        var strategyImplBase = new StrategyBase("EURUSD", strategyImpl, _apiHandlerMock.Object, _loggerMock.Object, _strategyServiceFactoryMock.Object);
        ...
        _strategyResultMock.VerifyAdd(x=>x.ResultTresholdEvent += It.IsAny<EventHandler<EventTreshold>>(),Times.Once);
    ...
    public void Init_Test_Chart()
    {
        ...
        _strategyServiceFactoryMock.Verify(x=>x.GetChart(It.IsAny<ILogger>(),It.IsAny<IApiProviderBase>(),It.IsAny<string>(),It.Is<Timeframe>(x=>x ==Timeframe.Daily)),Times.Once);
        _strategyServiceFactoryMock.Verify(x=>x.GetChart(It.IsAny<ILogger>(),It.IsAny<IApiProviderBase>(),It.IsAny<string>(),It.Is<Timeframe>(x=>x ==Timeframe.Monthly)),Times.Once);
        _strategyServiceFactoryMock.Verify(x=>x.GetChart(It.IsAny<ILogger>(),It.IsAny<IApiProviderBase>(),It.IsAny<string>(),It.Is<Timeframe>(x=>x ==Timeframe.Weekly)),Times.Once);
    ...
    public void Init_Test_Chart_no_main_chart()
    {
        ...
        Action act = () =>   new StrategyBase("EURUSD", strategyImpl, _apiHandlerMock.Object, _loggerMock.Object, _strategyServiceFactoryMock.Object);
    ...
    public void Test_StrategyBase_OnTickEvents(bool canRun, bool runOnTick, bool positionInProgress, bool expectedCallerRun, bool expectedCallerTick, bool expectedCallerCandle)
    {
        // Arrange
        var strategyImpl = new FakeStrategyContextTest();
    ...
    public void Test_OnNewTick_Run_PositionInProgress_Update(
        bool canRun, bool runOnTick, bool updateOnTick, bool shouldUpdatePositionReturn, int shouldUpdateTimes, int updatePositionTimes)
    {
        var strategyImpl =new FakeStrategyContextTest();
        strategyImpl.RunOnTick = runOnTick;
        ...
        // Assert
        _positionHandlerMock.Verify(x => x.UpdatePositionAsync(It.IsAny<Position>()), Times.Exactly(updatePositionTimes));
    }
    ...
    public void Test_OnNewTick_Run_PositionInProgress_Close(
        bool canRun, bool runOnTick, bool closeOnTick, bool shouldClosePositionReturn, int shouldCloseTimes, int closePositionTimes)
    {
        var strategyImpl =new FakeStrategyContextTest();
        strategyImpl.RunOnTick = runOnTick;
    ...
    public void Test_CandleEvent(bool canRun, bool runOnTick, bool positionInProgress, bool expectedCallerRun, bool expectedCallerTick, bool expectedCallerCandle)
    {
        // Arrange
        var strategyImpl = new FakeStrategyContextTest();
        strategyImpl.RunOnTick = runOnTick;
    ...
    public void Test_OnNewCandle_Close(
        bool canRun, bool runOnTick, bool closeOnTick, bool shouldClosePosition, int shouldUpdateTimes, int closePositionTimes)
    {
        var strategyImpl =new FakeStrategyContextTest();
        strategyImpl.RunOnTick = runOnTick;
        strategyImpl.CloseOnTick = closeOnTick;
    ...
    public void Init_Test_Indicators()
    {
        ...
        foreach (var indicator in strategyImplBase.MainIndicatorList)
        {
    ...
    public void Test_UpdateIndicator_Candle()
    {
        ...
        _chartMockMain.As<IChart>().Verify(x=>x.AggregateChart(It.Is<Timeframe>(y=>y == Timeframe.OneHour)),Times.Once);
        _chartMockMain.As<IChart>().Verify(x=>x.AggregateChart(It.Is<Timeframe>(y=>y  == Timeframe.OneMinute)),Times.Once);
        _chartMockMain.As<IChart>().Verify(x=>x.AggregateChart(It.Is<Timeframe>(y=>y== Timeframe.Monthly )),Times.Never);
        _chartMockMain.As<IChart>().Verify(x=>x.AggregateChart(It.Is<Timeframe>(y=>y == Timeframe.Weekly)),Times.Never);
    }
