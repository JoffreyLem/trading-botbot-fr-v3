...
public class FakeStrategyContextTest : StrategyImplementationBase
{
    ...
    {
        if (ShouldUpdatePositionProperty)
        {
            return true;
        }
    ...
    {
        if (ShouldClosePositionProperty)
        {
            return true;
        }
    ...
    public void OpenPositionForTest(TypeOperation typePosition, decimal sl , decimal tp, double volume = 0, double risk = 5)
    {
    ...
    [Timeframe(Timeframe.Weekly)] SarIndicator SarIndicator2;
